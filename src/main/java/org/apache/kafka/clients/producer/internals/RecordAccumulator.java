...
public final class RecordAccumulator {
    ...
    private final ConcurrentMap<TopicPartition, org.apache.kafka.common.utils.Deque<RecordBatch>> batches;
    ...
    public RecordAppendResult append(TopicPartition tp,
        ...
        try {
            ...
            org.apache.kafka.common.utils.Deque<RecordBatch> dq = getOrCreateDeque(tp);
            synchronized (dq) {
                if (closed)
     ...
     */
    private RecordAppendResult tryAppend(long timestamp, byte[] key, byte[] value, Callback callback, org.apache.kafka.common.utils.Deque<RecordBatch> deque) {
    ...
    public void reenqueue(RecordBatch batch, long now) {
        ...
        batch.setRetry();
        org.apache.kafka.common.utils.Deque<RecordBatch> deque = getOrCreateDeque(batch.topicPartition);
        synchronized (deque) {
    ...
    public ReadyCheckResult ready(Cluster cluster, long nowMs) {
        ...
        for (Map.Entry<TopicPartition, org.apache.kafka.common.utils.Deque<RecordBatch>> entry : this.batches.entrySet()) {
            ...
            org.apache.kafka.common.utils.Deque<RecordBatch> deque = entry.getValue();
    ...
    public Map<Integer, List<RecordBatch>> drain(Cluster cluster,
        ...
        for (Node node : nodes) {
            ...
            do {
                ...
                if (!muted.contains(tp)) {
                    org.apache.kafka.common.utils.Deque<RecordBatch> deque = getDeque(new TopicPartition(part.topic(), part.partition()));
                    if (deque != null) {
                        synchronized (deque) {
    ...
    private org.apache.kafka.common.utils.Deque<RecordBatch> getDeque(TopicPartition tp) {
     ...
     */
    private org.apache.kafka.common.utils.Deque<RecordBatch> getOrCreateDeque(TopicPartition tp) {
    ...
    /* Visible for testing */
    Map<TopicPartition, org.apache.kafka.common.utils.Deque<RecordBatch>> batches() {
    ...
    private void abortBatches() {
        for (RecordBatch batch : incomplete.all()) {
            org.apache.kafka.common.utils.Deque<RecordBatch> dq = getDeque(batch.topicPartition);
