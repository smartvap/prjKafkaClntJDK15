...
public interface OffsetCommitCallback {
     ...
     *
     * @throws org.apache.bi_kafka.clients.consumer.CommitFailedException if the commit failed and cannot be retried.
     ...
     * @throws org.apache.bi_kafka.common.errors.WakeupException if {@link KafkaConsumer#wakeup()} is called before or while this
     *             function is called
     * @throws org.apache.bi_kafka.common.errors.InterruptException if the calling thread is interrupted before or while
     *             this function is called
     * @throws org.apache.bi_kafka.common.errors.AuthorizationException if not authorized to the topic or to the
     *             configured groupId
     * @throws org.apache.bi_kafka.common.KafkaException for any other unrecoverable errors (e.g. if offset metadata
