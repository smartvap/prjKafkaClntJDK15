 ...
 * just log the errors.
 * <p>
 * ConsumerInterceptor callbacks are called from the same thread that invokes {@link org.apache.bi_kafka.clients.consumer.KafkaConsumer#poll(long)}.
 * <p>
...
public interface ConsumerInterceptor<K, V> extends Configurable {
    ...
    /**
     * This is called just before the records are returned by {@link org.apache.bi_kafka.clients.consumer.KafkaConsumer#poll(long)}
     * <p>
     ...
     * in the order specified by {@link org.apache.bi_kafka.clients.consumer.ConsumerConfig#INTERCEPTOR_CLASSES_CONFIG}.
