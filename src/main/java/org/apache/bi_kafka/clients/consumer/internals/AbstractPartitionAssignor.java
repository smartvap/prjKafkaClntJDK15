...
public abstract class AbstractPartitionAssignor implements PartitionAssignor {
    ...
    public Subscription subscription(Set<String> topics) {
        return new Subscription(new ArrayList<String>(topics));
    }

    public Map<String, Assignment> assign(Cluster metadata, Map<String, Subscription> subscriptions) {
        Set<String> allSubscribedTopics = new HashSet<String>();
        Map<String, List<String>> topicSubscriptions = new HashMap<String, List<String>>();
    ...
    protected static List<TopicPartition> partitions(String topic, int numPartitions) {
        List<TopicPartition> partitions = new ArrayList<TopicPartition>(numPartitions);
