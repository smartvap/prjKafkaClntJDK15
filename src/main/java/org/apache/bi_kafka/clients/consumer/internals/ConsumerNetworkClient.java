...
import org.apache.bi_kafka.common.errors.DisconnectException;
...
import org.apache.bi_kafka.common.requests.AbstractRequest;
...
public class ConsumerNetworkClient implements Closeable {
        ...
        public void fireCompletion() {
            if (e != null) {
                ...
                log.debug("Cancelled {} request {} with correlation id {} due to node {} being disconnected",
                        new Object[]{api, requestHeader, correlation, response.destination()});
     ...
     * access to {@link org.apache.bi_kafka.clients.NetworkClient}, which means implementations must be
