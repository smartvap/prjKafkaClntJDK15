...
public abstract class AbstractCoordinator implements Closeable {
    ...
    private RequestFuture<ByteBuffer> onJoinFollower() {
        ...
        log.debug("Sending follower SyncGroup for group {} to coordinator {}: {}",
                new Object[]{groupId, this.coordinator,
                requestBuilder});
    ...
    private RequestFuture<ByteBuffer> onJoinLeader(JoinGroupResponse joinResponse) {
        try {
            ...
            log.debug("Sending leader SyncGroup for group {} to coordinator {}: {}",
                    new Object[]{groupId, this.coordinator, requestBuilder});
            return sendSyncGroupRequest(requestBuilder);
    ...
    private class HeartbeatThread extends KafkaThread {
        ...
        private AtomicReference<RuntimeException> failed = new AtomicReference<RuntimeException>(null);

        private HeartbeatThread() {
            super("kafka-coordinator-heartbeat-thread" + (groupId.length() == 0 ? "" : " | " + groupId), true);
        }
    ...
    private static class UnjoinedGroupException extends RetriableException {
		...
		private static final long serialVersionUID = -5437265763256256547L;
