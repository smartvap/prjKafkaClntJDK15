 ...
 */
package org.apache.bi_kafka.clients.consumer.internals;

import org.apache.bi_kafka.clients.Metadata;
import org.apache.bi_kafka.clients.consumer.*;
import org.apache.bi_kafka.clients.consumer.internals.PartitionAssignor.Assignment;
import org.apache.bi_kafka.clients.consumer.internals.PartitionAssignor.Subscription;
...
import org.apache.bi_kafka.common.TopicPartition;
import org.apache.bi_kafka.common.errors.*;
...
import org.apache.bi_kafka.common.metrics.stats.Avg;
import org.apache.bi_kafka.common.metrics.stats.Count;
import org.apache.bi_kafka.common.metrics.stats.Max;
import org.apache.bi_kafka.common.metrics.stats.Rate;
import org.apache.bi_kafka.common.protocol.Errors;
import org.apache.bi_kafka.common.requests.OffsetCommitRequest;
import org.apache.bi_kafka.common.requests.OffsetCommitResponse;
import org.apache.bi_kafka.common.requests.OffsetFetchRequest;
import org.apache.bi_kafka.common.requests.OffsetFetchResponse;
import org.apache.bi_kafka.common.requests.JoinGroupRequest.ProtocolMetadata;
import org.apache.bi_kafka.common.requests.OffsetCommitRequest.PartitionData;
...
public final class ConsumerCoordinator extends AbstractCoordinator {
    ...
    protected void onJoinComplete(int generation,
        ...
        try {
            ...
            log.error("User provided listener {} for group {} failed on partition assignment",
                    new Object[]{listener.getClass().getName(), groupId}, e);
        }
    }
    ...
    protected Map<String, ByteBuffer> performAssignment(String leaderId,
        ...
        log.debug("Performing assignment for group {} using strategy {} with subscriptions {}",
                new Object[]{groupId, assignor.name(), subscriptions});
     ...
     * @throws org.apache.bi_kafka.common.errors.AuthorizationException if the consumer is not authorized to the group
    ...
    private void maybeAutoCommitOffsetsSync(long timeoutMs) {
        if (autoCommitEnabled) {
            ...
            try {
                ...
                log.warn("Auto-commit of offsets {} failed for group {}: {}",
                        new Object[]{allConsumedOffsets, groupId,
                        e.getMessage()});
            }
        }
    }
        ...
        public void onComplete(Map<TopicPartition, OffsetAndMetadata> offsets, Exception exception) {
            if (exception != null)
                log.error("Offset commit with offsets {} failed for group {}",
                        new Object[]{offsets, groupId}, exception);
        }
    }
    ...
    private RequestFuture<Void> sendOffsetCommitRequest(final Map<TopicPartition, OffsetAndMetadata> offsets) {
        ...
        log.trace("Sending OffsetCommit request with {} to coordinator {} for group {}",
                new Object[]{offsets, coordinator, groupId});
            ...
            for (Map.Entry<TopicPartition, Short> entry : commitResponse.responseData().entrySet()) {
                ...
                if (error == Errors.NONE) {
                    ...
                    log.debug("Offset commit for group {} failed on partition {}: {}",
                            new Object[]{groupId, tp, error.message()});
                    future.raise(error);
                    return;
                    ...
                    log.error("Group {} failed to commit partition {} at offset {}: {}",
                            new Object[]{groupId, tp, offset, error.message()});
