...
import org.apache.bi_kafka.clients.*;
...
import org.apache.bi_kafka.common.errors.InvalidMetadataException;
import org.apache.bi_kafka.common.errors.RetriableException;
import org.apache.bi_kafka.common.errors.TopicAuthorizationException;
import org.apache.bi_kafka.common.errors.UnknownTopicOrPartitionException;
...
import org.apache.bi_kafka.common.record.MemoryRecords;
import org.apache.bi_kafka.common.requests.ProduceRequest;
import org.apache.bi_kafka.common.requests.ProduceResponse;
...
public class Sender implements Runnable {
    ...
    private void handleProduceResponse(ClientResponse response, Map<TopicPartition, RecordBatch> batches, long now) {
        ...
        if (response.wasDisconnected()) {
            ...
            log.warn("Cancelled request" + response + " due to a version mismatch with node {}",
                     response.destination(), response.versionMismatch());
            for (RecordBatch batch : batches.values())
