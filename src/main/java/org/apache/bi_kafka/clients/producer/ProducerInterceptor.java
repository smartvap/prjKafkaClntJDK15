...
import org.apache.bi_kafka.common.Configurable;
 ...
 * <p>
 * Implement {@link org.apache.bi_kafka.common.ClusterResourceListener} to receive cluster metadata once it's available. Please see the class documentation for ClusterResourceListener for more information.
 */
public interface ProducerInterceptor<K, V> extends Configurable {
    /**
     * This is called from {@link org.apache.bi_kafka.clients.producer.KafkaProducer#send(ProducerRecord)} and
     * {@link org.apache.bi_kafka.clients.producer.KafkaProducer#send(ProducerRecord, Callback)} methods, before key and value
     ...
     * specified by {@link org.apache.bi_kafka.clients.producer.ProducerConfig#INTERCEPTOR_CLASSES_CONFIG}. The first interceptor
     ...
     *                 {@link org.apache.bi_kafka.clients.producer.KafkaProducer#send(ProducerRecord)}.
