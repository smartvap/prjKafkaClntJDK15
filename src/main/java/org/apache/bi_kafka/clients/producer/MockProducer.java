...
import org.apache.bi_kafka.clients.producer.internals.FutureRecordMetadata;
import org.apache.bi_kafka.clients.producer.internals.ProduceRequestResult;
...
public class MockProducer<K, V> implements Producer<K, V> {
    ...
    private final org.apache.bi_kafka.common.utils.Deque<Completion> completions;
    ...
    public MockProducer(Cluster cluster, boolean autoComplete, Partitioner partitioner, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
        ...
        this.completions = new org.apache.bi_kafka.common.utils.ArrayDeque<Completion>();
    }
