...
import org.apache.bi_kafka.clients.producer.ProducerInterceptor;
import org.apache.bi_kafka.clients.producer.ProducerRecord;
...
/**
 * A container that holds the list {@link org.apache.bi_kafka.clients.producer.ProducerInterceptor}
            ...
            try {
                ...
                if (record != null)
                    log.warn("Error executing interceptor onSend callback for topic: {}, partition: {}",
                            new Object[]{record.topic(), record.partition()}, e);
                else
