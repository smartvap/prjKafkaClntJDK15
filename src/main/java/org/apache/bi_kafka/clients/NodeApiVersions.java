...
import org.apache.bi_kafka.common.requests.ApiVersionsResponse.ApiVersion;
...
public class NodeApiVersions {
    ...
    public static NodeApiVersions create(Collection<ApiVersion> overrides) {
        List<ApiVersion> apiVersions = new LinkedList<ApiVersion>(overrides);
