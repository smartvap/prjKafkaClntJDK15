...
package org.apache.bi_kafka.common.requests;
...
import org.apache.bi_kafka.common.network.ListenerName;
...
public class UpdateMetadataRequest extends AbstractRequest {
    ...
    private UpdateMetadataRequest(short version, int controllerId, int controllerEpoch, Map<TopicPartition,
        ...
        List<Struct> brokersData = new ArrayList<Struct>(liveBrokers.size());
        for (Broker broker : liveBrokers) {
            ...
            if (version == 0) {
                ...
                List<Struct> endPointsData = new ArrayList<Struct>(broker.endPoints.size());
    ...
    public UpdateMetadataRequest(Struct struct, short versionId) {
        ...
        Set<Broker> liveBrokers = new HashSet<Broker>();
