...
package org.apache.bi_kafka.common.security;
...
class JaasConfig extends Configuration {
    ...
    public JaasConfig(LoginType loginType, String jaasConfigParams) {
        ...
        try {
            configEntries = new ArrayList<AppConfigurationEntry>();
    ...
    private LoginModuleControlFlag loginModuleControlFlag(String flag) {
        ...
        if ("REQUIRED".equals(flag.toUpperCase())) {
            controlFlag = LoginModuleControlFlag.REQUIRED;
        } else if ("REQUISITE".equals(flag.toUpperCase())) {
            controlFlag = LoginModuleControlFlag.REQUISITE;
        } else if ("SUFFICIENT".equals(flag.toUpperCase())) {
            controlFlag = LoginModuleControlFlag.SUFFICIENT;
        } else if ("OPTIONAL".equals(flag.toUpperCase())) {
