...
import org.apache.bi_kafka.clients.CommonClientConfigs;
...
import org.apache.bi_kafka.common.requests.AbstractResponse;
import org.apache.bi_kafka.common.requests.RequestHeader;
import org.apache.bi_kafka.common.requests.SaslHandshakeRequest;
import org.apache.bi_kafka.common.requests.SaslHandshakeResponse;
            ...
            return Subject.doAs(subject, new PrivilegedExceptionAction<SaslClient>() {
                public SaslClient run() throws SaslException {
                    ...
                    LOG.debug("Creating SaslClient: client={};service={};serviceHostname={};mechs={}",
                            new Object[]{clientPrincipalName, servicePrincipal, host, Arrays.toString(mechs)});
